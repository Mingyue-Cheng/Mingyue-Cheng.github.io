      ...
      pages: {
        ...
        'projects.html': {
          ...
          content: {
            ...
            'opensource.category.timeseries': 'Time Series Intelligence',
            'opensource.category.science': 'Science Intelligence（Scientific Tool and Knowledge）',
            'datasets.heading': 'Benchmarks &amp; Datasets',
            'datasets.category.science': 'Science Intelligence',
            'datasets.category.timeseries': 'Time Series Intelligence',
      ...
      pages: {
        ...
        'projects.html': {
          ...
          content: {
            ...
            'opensource.category.timeseries': '时序智能',
            'opensource.category.science': 'Science Intelligence（Scientific Tool and Knowledge）',
            'datasets.heading': '基准与数据集',
            'datasets.category.science': '科学智能',
            'datasets.category.timeseries': '时序智能',
